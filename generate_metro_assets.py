...
SCENES = [
    ...
    ("02_face_scan", "Close up grotesque biometric face scanner, red laser grid mapping a weeping human face, dystopian technology", "digital scanning noise textured mid-pitch beep laser hum"),
    ("03_finger_scan", "Futuristic security device crushing a human finger against a glass plate, green light, macro photography", "mechanical servo growl textured glass squeak crunch"),
    ...
    ("07_retina_drill", "Eye scanning device that looks like a surgical drill, red laser beam pointing into pupil, extreme close up", "gritty mechanical drill growl textured laser zap"),
    ...
    ("09_hair_count", "Robotic tweezers plucking a single hair from a scalp, digital counter display showing numbers", "gritty pluck sound textured digital counter tone"),
    ...
    ("15_memory_wipe", "Flash of white light, person looking dazed and empty, pupil dilated, bright overexposed", "camera flash capacitor charge textured mid-pitch ring"),
    ...
    ("18_nail_pull", "Automated pliers extracting a single fingernail for mineral analysis, clinical cold lighting", "textured metallic snap scream muffled"),
    ("19_skin_swatch", "Robotic laser cutter removing a small square of skin from a forearm, precise glowing line", "textured laser sizzle clinical tone"),
    ("20_tooth_scan", "Mechanical mouth spreader exposing teeth, blue UV light scanning for dental records", "textured dental drill growl mid-frequency vibration"),
